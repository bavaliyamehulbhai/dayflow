...
const TIER_CONFIG = {
  bronze: {
    ...
    gradient: "linear-gradient(135deg,#cd7f32,#b8650a)",
  },
  silver: {
    label: "Silver",
    color: "#a8a9ad",
    glow: "rgba(168,169,173,0.35)",
    gradient: "linear-gradient(135deg,#c0c0c0,#a8a9ad)",
  },
  gold: {
    label: "Gold",
    color: "#ffd700",
  ...
  platinum: {
    ...
    gradient: "linear-gradient(135deg,#e5e4e2,#9fa0a3)",
  },
};
...
export default function ProfilePage() {
  ...
  const passwordMutation = useMutation({
    ...
    onError: (e) =>
      addToast(e.response?.data?.error || "Password change failed", "error"),
  });
  ...
  const handlePasswordChange = (e) => {
    ...
    if (pwStrength < 2)
      return addToast("Please use a stronger password", "error");
  ...
  const memberDays =
    user?.createdAt && !isNaN(new Date(user.createdAt).getTime())
      ? Math.abs(differenceInDays(new Date(), new Date(user.createdAt)))
      : 0;
  const avatarGrad =
    AVATAR_GRADIENTS[profileForm.avatarGradient] || AVATAR_GRADIENTS.purple;
  ...
  const byTier = ["bronze", "silver", "gold", "platinum"].map((tier) => ({
    tier,
    badges: catalogue.filter((b) => b.tier === tier),
  }));
                ...
                >
                  {Object.entries(AVATAR_GRADIENTS).map(([key, grad]) => (
                    <button
                      key={key}
                      onClick={() => {
                        setProfileForm((f) => ({ ...f, avatarGradient: key }));
                      ...
                      style={{
                        ...
                        background: grad,
                        border:
                          profileForm.avatarGradient === key
                            ? "2.5px solid white"
                            : "none",
                        cursor: "pointer",
                        transition: "all 0.2s",
        ...
        {TABS.map((tab) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className={isMobile && !active ? "hide-mobile" : ""}>
                {tab.label}
              </span>
            </button>
          );
        ...
        >
                ...
                >
                  <div className="form-group">
                    ...
                    <input
                      ...
                      style={{ height: isMobile ? 48 : 56, borderRadius: 16 }}
                    />
                  </div>
                  ...
                  <div style={{ marginTop: 12 }}>
                    ...
                    >
                      ...
                      {profileMutation.isPending ? (
                        ...
                        <>
                          <Save size={18} style={{ marginRight: 10 }} /> Update
                          Identity
                        </>
                      )}
                    </button>
              ...
              >
                ...
                >
                  {[
                    ...
                    {
                      label: "Deep Focus (hrs)",
                      value: Math.floor(focusMinutes / 60),
                      target: 100,
                      icon: Clock,
                      color: "#22c55e",
                    },
          ...
          {activeTab === "security" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
              ...
              >
                ...
                >
                  {securityHistory.logs.length === 0 ? (
                    ...
                    >
                      No intercepted threats recorded
                    </div>
                  ) : (
                    securityHistory.logs.slice(0, 5).map((log, i) => (
                      ...
                      >
                        ...
                        >
                          {safeFormat(log.createdAt, "MMM d, HH:mm", "N/A")}
                        </div>
                      </div>
                    ))
                  )}
              ...
              >
                ...
                >
                  You retain total dominance over your data. Export your
                  consciousness or initiate a total purge at any time.
                </p>
          ...
          {activeTab === "appearance" && (
            ...
            >
              ...
              >
                Calibrate your neural interface with a custom spectrum. Changes
                are synchronized across your consciousness.
              </p>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: "var(--muted)" }}>
                      Zenith is optimized for deep work in low-light
                      environments.
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              >
                {[
                  {
                    key: "pomodoroWork",
                    label: "Neural Focus Depth",
                    hint: "Deep integration period",
                    icon: Brain,
                    color: "#7c6dfa",
                    max: 90,
                  },
                  ...
                  <div key={f.key} className="form-group">
                    ...
                    >
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{
                          width: `${(profileForm[f.key] / f.max) * 100}%`,
                        }}
                        style={{
                          height: "100%",
                          background: f.color,
                          borderRadius: 20,
                          boxShadow: `0 0 15px ${f.color}44`,
                        }}
                      />
                      <input
                        type="range"
                  ...
                  <div>
                    ...
                    >
                      {4 * profileForm.pomodoroWork +
                        ...
                        profileForm.pomodoroLong}{" "}
                      Minutes of Optimized Focus
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  {profileMutation.isPending ? (
                    ...
                    <>
                      <Save size={18} style={{ marginRight: 10 }} /> Store
                      Protocol
                    </>
                  )}
                </button>
                  ...
                  <div style={{ flex: 1, minWidth: 280 }}>
                    ...
                    >
                      {[
                        {
                          label: "Tasks (35%)",
                          val: (Math.min(tasksCompleted, 100) / 100) * 35,
                          max: 35,
                          color: "#7c6dfa",
                        },
                        {
                          label: "Focus (30%)",
                          val: (Math.min(focusMinutes / 60, 50) / 50) * 30,
                          max: 30,
                          color: "#22c55e",
                        },
                        {
                          label: "Streak (20%)",
                          val: (Math.min(longestStreak, 30) / 30) * 20,
                          max: 20,
                          color: "#f59e0b",
                        },
                        {
                          label: "Badges (15%)",
                          val: (earnedCount / totalBadges) * 15,
                          max: 15,
                          color: "#ffd700",
                        },
                      ].map((b) => (
                  ...
                  >
                    ...
                    {activityData.length > 0 ? (
                      <ActivityHeatmapYear
                        data={activityData}
                        isMobile={isMobile}
                        onSelectDay={(date, log) =>
                          setSelectedDayData({ date, log })
                        }
                      />
                    ) : (
                      <div
                      ...
                      >
                        ...
                        >
                          Your neuro-activity logs are currently empty. Complete
                          your first Tactical Objective or Habit to begin the
                          synchronization.
                        </p>
                        <button
                          className="auth-button haptic-tap"
                  ...
                  >
                    <motion.div
                      ...
                      style={{
                        height: "100%",
                        background:
                          "linear-gradient(90deg, #cd7f32, #ffd700, #e5e4e2)",
                        borderRadius: 10,
                        ...
                        >
                          ...
                          <div
                            style={{
                              fontSize: 15,
                              fontWeight: 800,
                              color: badge.earned ? "white" : "var(--muted)",
                              marginBottom: 6,
                            }}
                          >
                          ...
                          {badge.earned && badge.earnedAt && (
                            ...
                            >
                              ACQUIRED •{" "}
                              {safeFormat(badge.earnedAt, "MMM d", "N/A")}
                            </div>
                          )}
                        </motion.div>
                      ))}
